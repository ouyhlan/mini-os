...
data:
    WelcomingMessage db "  Hello, this is ouyhlan's monitor program! The following is the user programs which you can use: ", 0dh, 0ah
    WelcomingMessageLength  equ ($-WelcomingMessage)
    UserMessage db "os1> "
    UserMessageLength equ ($-UserMessage)
